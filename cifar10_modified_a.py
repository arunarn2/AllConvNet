# Model a from https://arxiv.org/pdf/1412.6806.pdf
import numpy as np
import six
import os
import pickle
...
tf.app.flags.DEFINE_string('summaries_dir', './cifar10_modified_a', 'Summaries directory')
...
# to whiten compute matrix of eigen vectors of the covariance of the dataset
...
with tf.name_scope('conv3'):
    ...
    conv3 = tf.nn.relu(tf.nn.bias_add(conv2d_s2_same(conv1, W_conv3), b_conv3))
...
with tf.name_scope('conv6'):
    ...
    conv6 = tf.nn.relu(tf.nn.bias_add(conv2d_s2_same(conv4, W_conv6), b_conv6))
...
save_path = saver.save(sess, "./cifar10_modified_model_a.ckpt")
