# Model C from https://arxiv.org/pdf/1412.6806.pdf
import numpy as np
import six
import os
import pickle
...
tf.app.flags.DEFINE_string('summaries_dir', './cifar10_modified_c', 'Summaries directory')
...
train_writer = tf.summary.FileWriter(FLAGS.summaries_dir + '/cifar10_train', sess.graph)
test_writer = tf.summary.FileWriter(FLAGS.summaries_dir + '/cifar10_test')
...
save_path = saver.save(sess, "./cifar10_modified_model_c.ckpt")
